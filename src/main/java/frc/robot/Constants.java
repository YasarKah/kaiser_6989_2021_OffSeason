...
public final class Constants {
    public static final class DriveConstants {
        ...
        public static final int kLeft_Master_Port = 33;
        public static final int kLeft_Slave_Port = 44;
        public static final int kRight_Master_Port = 11;
        public static final int kRight_Slave_Port = 22;
        ...
        public static final double kTurn_Rate_Tolerance_DegPerS = 8;
        ...
        public static final double kTrack_Width_Meters = 0.65;
    ...
    public static final class ShooterConstants {
        public static final int kShooter_Motor_Port = 23;
    ...
    public static final class IndexerConstants {
        public static final int kIndexer_Motor_Port = 40;

        public static final double kIndexer_Motor_speed = 0.3;
    }

    public static final class IntakeConstants  {
        public static final int kIntake_Motor_Port = 24;

        public static final int kIntake_Solenoid_port = 0;
    ...
    public static final class ClimberConstants {
        public static final int kClimber_Elevator_Motor_Port = 12;
        public static final int kClimber_Winch_Motor_Port = 38;
