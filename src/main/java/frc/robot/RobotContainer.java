...
public class RobotContainer {
  ...
  public final lightSubsystem  ledSystem = new lightSubsystem(); 

  private final AutoGenerator autoGenerator = new AutoGenerator(m_drive, m_shooter, m_indexer, m_intake);
  ...
  public static final ShuffleboardTab driverTab = Shuffleboard.getTab("Otonom & Drive");
  



  public RobotContainer() {
    m_drive.setDefaultCommand(new TeleDriveCommand(driver_Controller, m_drive, ledSystem));
